...
btn_params = {'padx': 16, 'pady': 1, 'bd': 4, 'fg': 'black', 'bg': 'white', 'font': ('arial', 18),
              'width': 2, 'height': 2, 'relief': 'flat', 'activebackground': "white"}
...
class Calculator:
    def __init__(self, master):
        ...
        bottom_frame = tk.Frame(
            master, width=650, height=470, bd=2, relief='flat', bg='white')
        bottom_frame.pack(side=tk.BOTTOM)

        # Here is the code for Display of Calculator.
        # entry interface for inputs
        txt_display = tk.Entry(top_frame, font=('arial', 36), relief='flat', bg='white', fg='black',
        ...
        self.btn_Deg = tk.Button(bottom_frame, **btn_params, activeforeground='gray', text="Deg",
                                 command=self.convert_deg)
        self.btn_Deg.grid(row=1, column=0)
        # changes trig function outputs to default back to radians
        self.btn_Rad = tk.Button(bottom_frame, **btn_params, foreground='white', activeforeground='Gray', text="Rad",
        ...
        self.btn_0.configure(activebackground="gray", bg='white', width=7, bd=5)
